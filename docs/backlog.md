...
| ID      | Status | Task                                                        | Acceptance evidence                                      |
| ------- | ------ | ----------------------------------------------------------- | -------------------------------------------------------- |
| M4-001  | todo   | Build provider adapter contract                             | Unit tests with fixture provider messages                |
| M4-002  | todo   | Normalize BTC/ETH ticks to decimal strings                  | Schema tests                                             |
| M4-003  | todo   | Persist market ticks and candles                            | Integration tests with mocked provider input             |
| M4-004  | todo   | Report provider reconnect and health status                 | Logs and admin health output                             |
